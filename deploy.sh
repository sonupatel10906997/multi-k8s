...
docker push sonupatel10906997/mutli-client:latest
docker push sonupatel10906997/mutli-worker:latest
docker push sonupatel10906997/multi-server:latest

docker push sonupatel10906997/mutli-client:$SHA
docker push sonupatel10906997/mutli-worker:$SHA
...
kubectl set image deployment/client-deployment client=sonupatel10906997/mutli-client:$SHA
